(defpackage :lil/interface/monad/test/monad/continuation
  (:use :cl
   :lil/interface/base
   :lil/interface/monad
...
(in-package :lil/interface/monad/test/monad/continuation)

(defmethod test-for-check-monad-laws ((<c> <continuation>) cmv)
  (test-for-check-monad-laws <monad> (run <c> cmv)))
...
(defmethod check-invariant ((<c> <continuation>) monad &key &allow-other-keys)
